...
long long checkPoint[100000001][100000001]={0,};
int dx[4] = {0,1,0,-1};
int dy[4] = {1,0,-1,0};
...
int main(int argc, const char * argv[]) {
    ...
    for(int i = 0;i<N;i++){
        int xi, yi;
        cin >> xi >> yi;
        checkPoint[xi][yi] = i+1;
        
    }
    for(int i =0;i<Q;i++){
        int Ai, Bi, Xi;
        cin >> Ai >> Bi >> Xi;
        q.push(make_pair(Ai, Bi));
...
//
//3번 체크포인트에서 충전 후, 3번 체크포인트에서 (3, 2.5) 방향으로 직선으로 걸어감.  의 HP를 사용하여서 현재 HP가 약 0.197224 정도가 됨.
